#ifndef EXIBIR_ALUNOS_APROVADOS_E_MEDIA_H
#define EXIBIR_ALUNOS_APROVADOS_E_MEDIA_H
...
void Exibir_Alunos_Aprovados_E_Medias(void){
    FILE *dt;
    char linha[500];
    ...
    printf("\n==============================================================================");
    printf("\n=================== Lista de medias de alunos Aprovados ======================");
    printf("\n==============================================================================");
    ...
    while(fgets(linha, sizeof(linha), dt) != NULL){
        if(sscanf(linha, "MATRICULA:%d|NOTA1:%f|NOTA2:%f|NOTA3:%f|NOTA4:%f|MEDIA:%f|ESTADO:%s",
            ...
            aluno_temporario.Estado) == 7){
                if(strcmp(aluno_temporario.Estado, "ALUNO_APROVADO") == 0){
                    contador ++;
                    printf("\n==============================================================================");
                    printf("\n--- ALUNO %d ---", contador);
    ...
    if (contador == 0){
        ...
        printf("\n==============================================================================");
        printf("\n======================== Total de alunos Aprovado: %d =====================", contador);
        printf("\n==============================================================================");
